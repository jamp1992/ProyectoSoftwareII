...
public class PanelMantenimiento extends JPanel {
	...
	public JButton btnSolicitarServicio;
	public JButton btnNuevoServicio;
	public Object[][] datos;
	...
	new String[] {
		...
		JButton btnServicios_Disponibles = new JButton("Buscar Servicios_Disponibles");
		 btnServicios_Disponibles.setBounds(50, 11, 280, 23);
		add( btnServicios_Disponibles);
		...
		btnSolicitarServicio.setBounds(90,230,200,20);
		paneldatos.add(btnSolicitarServicio);
		
		
		JButton btnNuevoServicio= new JButton("Nuevo Servicio");
		btnNuevoServicio.setBounds(90,260,200,20);
		paneldatos.add(btnNuevoServicio);
	}}     
